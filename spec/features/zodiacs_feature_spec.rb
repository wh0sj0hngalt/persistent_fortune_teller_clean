...
RSpec.describe 'Zodiacs feature', type: :feature do
  ...
  context 'Part 2' do
    describe "GET /signs/:the_sign" do
      it "displays the content from :the_sign params" do
        visit '/signs/aries'
        expect(page).to have_content('aries')
      end

      it "displays the sign and fortune for each Zodiac" do
    ...
    describe "GET /creature/:the_creature" do
      it "displays the content from :the_creature params" do
        visit '/creatures/ram'
        expect(page).to have_content('ram')
      end

      it "displays the creature and fortune for each Zodiac" do
        Zodiac.all.each do |zodiac|
